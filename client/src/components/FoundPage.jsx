...
function App() {
  ...
  return (
    <div className="app">
      <NavBar></NavBar>
      <h2 className="pageInfo">
        These pets are found! Please help to find their owners.
      </h2>
      <section className="button-container">
        <button onClick={toFoundForm} className="form-button">
          Found A Pet
        </button>
      </section>
      ...
      <main className="main-content">
        <section className="found-info">
                      ...
                      <tr>
                        ...
                        <td>
                          <button
                            ...
                            onClick={() => handleShowDetails(foundItem)}
                          >
          ...
          <div className="pagination">
            {Array.from(
              { length: Math.ceil(foundData.length / itemsPerPage) },
              (_, index) => (
                <button
                  key={index + 1}
